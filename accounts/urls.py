...
from django.contrib.auth.views import (
    login, logout,PasswordResetView,PasswordChangeDoneView,PasswordResetConfirmView,
...
urlpatterns = [
    ...
    url(r'^reset-password/done/$',PasswordChangeDoneView, {'template_name': 'accounts/reset_password_done.html'}, name='password_reset_done'),
